...
<main class="font-outfit flex flex-wrap gap-12 mx-auto items-center justify-center md:max-w-4xl">
    <section class="bg-darkblue p-5 mx-5 rounded-xl max-w-xs shadow-2xl" id="refugio">
        ...
        <h1>
            <div>
                <button onclick="openModalRefugio()" class="block text-white my-4 font-boldao text-2xl hover:text-cyan-400">
                    Passport Refugio
    ...
    <section class="bg-darkblue p-5 mx-5 rounded-xl max-w-xs shadow-2xl" id="panama">
        <a href="#" class="group block relative rounded-md overflow-hidden">
            <div class="invisible group-hover:visible absolute inset-0 bg-cyan-100">
                <img
                    src="{{asset("/img/icons/eye.svg")}}"
        ...
        <h1>
            <div>
                <button onclick="openModalPanama()" class="block text-white my-4 font-boldao text-2xl hover:text-cyan-400">
                    Passport Refugio
                    <i class="fa-solid fa-circle-info text-dao ml-3 hover:text-white"></i>
                </button>
        ...
        <div class="main-modalpanama fixed w-full h-100 inset-0 z-50 overflow-hidden flex justify-center items-center animated fadeIn faster"
             style="background: rgba(0,0,0,.7);">
            <div
                class="border border-teal-500 shadow-lg modal-container bg-white w-11/12 md:max-w-md mx-auto rounded shadow-lg z-50 overflow-y-auto">
                <div class="modal-content py-4 text-left px-6">
        ...
        <script>
            const modal = document.querySelector('.main-modalPanama');
            const closeButton = document.querySelectorAll('.modal-closePanama');

            const modalClose = () => {
                modal.classList.remove('fadeInPanama');
                modal.classList.add('fadeOutPanama');
                setTimeout(() => {
                    modal.style.display = 'none';
                }, 500);
            }

            const openModalPanama = () => {
                modal.classList.remove('fadeOutPanama');
                modal.classList.add('fadeInPanama');
                modal.style.display = 'flex';
            }
