...
<main class="font-outfit flex flex-wrap gap-12 mx-auto items-center justify-center md:max-w-4xl">
    <section class="bg-darkblue p-5 mx-5 rounded-xl max-w-xs shadow-2xl">
        ...
        <h1>
            <div>
                <button onclick="openModalRefugio()" class="block text-white my-4 font-boldao text-lg hover:text-cyan-400">
                    Passport Refugio
              ...
              <div
                  ...
                  <div class="modal-content py-4 text-left px-6">
                      ...
                      <div class="flex justify-end pt-2">
                          <a href="https://opensea.io/assets/0x495f947276749ce646f68ac8c248420045cb7b5e/10476208371703460535276576839065665727776608392811958092550952984407133126657" class="focus:outline-none px-4 bg-lightgreen p-3 ml-3 rounded-lg font-boldao text-white uppercase">Collect</a>
                      </div>
                  </div>
              </div>
          </div>
        ...
        <p class="text-soft-blue font-light text-xs	">
        ...
        <div class="flex justify-between items-center mt-4">
          ...
          <div class="flex items-center text-soft-blue space-x-2 whitespace-nowrap">
            <p class="font-semibold">500 <p class="text-xs font-semibold">units</p></p>
          </div>
        </div>
    ...
    <section class="bg-darkblue p-5 mx-5 rounded-xl max-w-xs shadow-2xl ">
        ...
        <h1>
            <a href="#" class="block text-white my-4 font-boldao text-lg hover:text-cyan-400">
                Passport Panamá
            </a>
        </h1>
