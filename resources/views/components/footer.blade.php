<footer class="p-4 bg-gray-800 sm:p-6 dark:bg-gray-800 bottom-0 absolute w-full">
    <div class="md:flex md:justify-between">
        ...
        <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
                <h3 class="mb-6 text-sm font-semibold uppercase text-white">Resources</h3>
                <ul>
                    <li class="mb-4">
            ...
            <div>
                ...
                <ul>
                    <li>
                        <a href="#" target="_blank" class=" hover:underline text-gray-400">Terms &amp; Conditions</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="sm:flex sm:items-center sm:justify-between">
        <span class="text-sm sm:text-center text-gray-400 items-center">© 2022 <a href="https://flowbite.com" target="_blank" class="hover:underline">BocasDAO™</a>. All Rights Reserved.
        </span>
