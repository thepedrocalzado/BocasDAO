...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <div class="bg-lightgreen m-20">
        <p>
            BocasDAO (“We” or “BocasDAO” ) exists to build and operate a boutique hotel in Bocas del Toro with a strong focus towards the crypto community.

            We are offering for sale four types of digital collectibles: The “Passport Refugio”, “Passport Carenero”, “Passport Bocas” and “Passport Panama”. The purchase of each NFT is a transaction in goods and not a promise to provide, or a guarantee of receipt of, future services from BocasDAO, although BocasDAO will make reasonable efforts to ensure that a DAO comes into existence which allows you to unlock expanded functionality associated with the Passport NFTs.
            ...
            If you have any questions please contact BocasDAO at contact@bocasdao.finance
        </p>
    </div>
